...
import ProductPage from './VideoGame';
    ...
    return (
        <div className="sidebar">
            <div className="sidebar-home">
                <a href="/" className="sidebar-home-button">ACCUEIL</a>
                <a href="#" className="grid-display">
                    <span className="grey-bloc-grid-display top-left"></span>
                    <span className="grey-bloc-grid-display top-right"></span>
                    <span className="grey-bloc-grid-display bottom-right"></span>
                    <span className="grey-bloc-grid-display bottom-left"></span>
                </a>
            </div>

            <section className="display-all">
                <h4>Tous <span className="dark-text">({videoGames.length}/117)</span></h4>
            </section>
            <section className="video-games-list">
                <ul>
                    {videoGames.map(videoGame => (
                        <li className="video-game-line">
                            <Link to={"/" + videoGame.link} className={videoGame.active ? 'active' : ''}>                                    
                                <span className="vg-list-icon" style={{backgroundImage: videoGame.icon}}></span>
